...
(
	...
	--CONSTRAINT FK_CUSS FOREIGN KEY(FK_CUSTOMER) REFERENCES CUSTOMERS(IDENTIFIER_CUST),
	CONSTRAINT FK_SS FOREIGN KEY(FK_SELLER) REFERENCES SELLERS(IDENTIFIER_SEL),
