...
DROP DATABASE DEMO_VENTAS_AMAZON
GO

CREATE DATABASE DEMO_VENTAS_AMAZON
ON PRIMARY
(
NAME=DEMO_VENTAS_AMAZON_MDF,
FILENAME='C:\BD\MSSQLS DEMO_VENTAS_AMAZON\DEMO_VENTAS_AMAZON_MDF.mdf',
SIZE=500MB,
MAXSIZE=1024MB,
FILEGROWTH=10%
)
LOG ON
(
NAME=DEMO_VENTAS_AMAZON_LDF,
FILENAME='C:\BD\MSSQLS DEMO_VENTAS_AMAZON\DEMO_VENTAS_AMAZON_LDF.ldf',
SIZE=500MB,
MAXSIZE=1024MB,
FILEGROWTH=10%
)
...
(
	...
	CONSTRAINT PK_CS PRIMARY KEY(IDENTIFIER_CLI)
)
GO
...
(
	...
	CONSTRAINT PK_SEL PRIMARY KEY(IDENTIFIER_VEND)
)
GO
...
(
	...
	CONSTRAINT FK_VENDP FOREIGN KEY(ID_VENDEDOR) REFERENCES PROVEDORES(IDENTIFIER_VEND),
	CONSTRAINT FK_PV FOREIGN KEY(ID_PROD) REFERENCES PRODUCTOS(IDENTIFIER_PROD)
)
GO
...
(
	...
	CONSTRAINT PK_SALE PRIMARY KEY(ORDER_ID),	
...
(
	...
	CONSTRAINT FK_ORD FOREIGN KEY(FK_ORDEN) REFERENCES ORDENES_DE_VENTA(ORDER_ID),
	CONSTRAINT FK_PR FOREIGN KEY(FK_PRODUCT) REFERENCES PRODUCTOS(IDENTIFIER_PROD),
	CONSTRAINT FK_CL FOREIGN KEY(FK_CLIENTE) REFERENCES CLIENTES(IDENTIFIER_CLI)
)
GO
...
(
	...
	CONSTRAINT FK_SALDEL FOREIGN KEY(FK_VENTA)REFERENCES ORDENES_DE_VENTA(ORDER_ID)
)
GO
